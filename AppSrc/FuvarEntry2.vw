// C:\Visual DataFlex Projects\Szallitmanyozas\AppSrc\FuvarEntry2.vw
// FuvarEntry2
//
...
ACTIVATE_VIEW Activate_oFuvarEntry2 FOR oFuvarEntry2
Object oFuvarEntry2 is a dbView
    Set Location to 5 5
    Set Size to 248 534
    Set Label To "FuvarEntry2"
    ...
    Object oGepkocsiRendszam is a dbForm
        ...
        Set peAnchors to anLeftRight
        Set Label to "GÇpj†rmu rendsz†ma"
        Set Label_Justification_mode to jMode_Left
        Set Label_Col_Offset to 158
        Set Label_row_Offset to 0
    End_Object 
